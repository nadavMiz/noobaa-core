...
class NamespaceFS {
    ...
    // NOTE on versioning - according to aws specifications, the version_id time should be based on when we created the upload.
    // on our design we desided to do it based on when the upload was completed. see https://docs.aws.amazon.com/AmazonS3/latest/userguide/mpuoverview.html#distributedmpupload
